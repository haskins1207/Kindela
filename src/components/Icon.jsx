// Lightweight 2px-stroke line icons (brand spec: line/stroke style, 24px standard).
const paths = {
  link: (
    <>
  ...
  scale: (
    <>
      ...
      <path d="m4 7 4-2 4 2M4 7l-2 5a3 3 0 0 0 6 0L6 7M20 9l-4-2-4 2M20 9l-2 5a3 3 0 0 0 6 0l-2-5" />
    </>
  ),
  eye: (
    <>
...
export default function Icon({ name, size = 24, stroke = 'currentColor', ...rest }) {
  return (
    <svg
      width={size}
      height={size}
